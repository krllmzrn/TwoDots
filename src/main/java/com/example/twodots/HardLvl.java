...
public class HardLvl {
    ...
    private Button home;
    @FXML
    private Label Moves, Blue,Yellow,Red;
    private int moves=20;
    private int blue,red,yellow=0;
    @FXML
    ...
    private void drawLines() {
        for (int i = 0; i < circles.size()-1; i++) {
            ...
            line.setStrokeWidth(7); // устанавливаем толщину линии
    ...
    private void Score(){
        ...
        moves--;
        if (red==30 && yellow==30 &&blue==30)
        {
            win.setVisible(true);
            gridPane.setVisible(false);
        }
        if (moves==0 && (red<30 || yellow<30 || blue<30 ))
        {
